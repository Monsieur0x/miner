...
twitch_miner = TwitchChannelPointsMiner(
    username="yanefarmilka",
    password="1234567890-Bb",           # If no password will be provided, the script will ask interactively
